...
public class NNTPConnection extends Thread
{
  ...
  private boolean            debug              
    = Boolean.parseBoolean(Config.getInstance().getProperty("n3tpd.debug", "false"));
  private Socket             socket;
  private boolean            exit               = false;
  private BufferedWriter     out;
  private BufferedReader     in;
  private File               articleDir         = new File(Config.getInstance().getProperty("n3tpd.datadir"));
  ...
  public void run()
  {
    ...
    try
    {
      printStatus(200, Config.getInstance().getProperty("n3tpd.hostname")
